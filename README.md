...
## Formatting messages
TODO: rewrite
OLD: The "MessageBuilderUtils" class is a utilities class for formatting. To format "hi" in bold, you can do "FormatUtils.bold("hi")", which will return "hi" with the html Skype tags. If you wanted "hi" to be in bold and blink, you can do "FormatUtils.bold(FormatUtils.blink("hi"))". When sending raw messages, I highly suggest you encode them using MessageBuilderUtils#encodeRawText
